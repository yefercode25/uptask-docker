...
const ModalEliminarTarea = () => {
  ...
  return (
    <Transition.Root show={modalEliminarTarea} as={Fragment}>
      <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={() => handleEliminarTarea({} as ITareaSaveValues)}>
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                <button
                  ...
                  onClick={() => handleEliminarTarea({} as ITareaSaveValues)}
                >
